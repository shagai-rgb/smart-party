...
import { BriefcaseBusinessIcon, PlusCircleIcon, PlusIcon } from 'lucide-react'
...
export const PositionSchema = z.object({
  position_name: z.string().min(1, 'Нэр заавал'),
  short_name: z.string().min(1, 'Товч нэр оруулах')
})

export type TParams = z.infer<typeof PositionSchema>

export const StructurePositionCreate = () => {
    ...
    <Sheet>
      <SheetTrigger asChild>
        <Button
          ...
          size="sm"
        >
          <PlusCircleIcon /> Албан тушаал нэмэх
        </Button>
      </SheetTrigger>
      <SheetContent>
        <SheetHeader className="pb-0 ">
          <SheetTitle className="flex items-center gap-1.5">
            <BriefcaseBusinessIcon /> Шинэ албан тушаал нэмэх
          </SheetTitle>
