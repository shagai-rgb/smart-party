...
import { TPrivateAudit } from '@/shared/mock/private-audit.data'
...
type TProps = {
  private_audit: TPrivateAudit
}

export const PrivateAuditEdit = ({ private_audit }: TProps) => {
  ...
  useEffect(() => {
    if (private_audit) {
      form.reset({
        full_name: private_audit.full_name,
        short_name: private_audit.short_name,
        website: private_audit.website,
        phone: private_audit.phone,
        email: private_audit.email,
        address: private_audit.address,
        established_date: private_audit.established_date,
        primary_color: private_audit.primary_color,
        secondary_color: private_audit.secondary_color,
        logo: null
      })
    }
  }, [private_audit, form])
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="space-y-4">
              ...
              <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <OrgLogoForm source={private_audit} />

                <div className="flex flex-col">
                  <h3 className="text-xs font-semibold  tracking-wider text-muted-foreground mb-4 flex items-center gap-1.5">
