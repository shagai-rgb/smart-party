...
import { TElection } from '@/shared/mock/election.data'
...
import { OrganizationCreateSchema, TParams } from './organization-create.sheet'

type TProps = {
  election: TElection
}

export const OrganizationEdit = ({ election }: TProps) => {
  ...
  useEffect(() => {
    if (election) {
      form.reset({
        ...
        website: election.website,
        phone: election.phone,
        email: election.email,
        address: election.address,
        established_date: election.established_date,
