...
function TableBody({ className, ...props }: React.ComponentProps<'tbody'>) {
  return (
    <tbody
      ...
      className={dx('body-compact-01', className)}
      {...props}
    />
  )
}
...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={dx(
        'heading-compact-01',
        //hover:border-b-primary FIXME
        'text-foreground  h-10 border-r border-b px-2 text-left align-middle whitespace-nowrap last:border-r-0 [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
        className
      )}
      {...props}
    />
